    ...
    <Layout>
      <BoardContent>
        <p>
          ...
          infinito da leve névoa que cobre o cenário, e, em uma das janelas voce nota pequenos pontos de luz, que
      ...
      <Option board={4}>Forçar passagem pela barricada</Option>
